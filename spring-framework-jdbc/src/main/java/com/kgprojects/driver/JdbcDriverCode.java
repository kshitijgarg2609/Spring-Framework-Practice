...
import com.kgprojects.dao.ConsoleHandler;
import com.kgprojects.javaconfig.JdbcConfig;

public class JdbcDriverCode
{
	private static Thread loop = new Thread()
	{
		public void run()
		{
			...
			ConsoleHandler ch = context.getBean("ch",ConsoleHandler.class);
			ch.printLine();
			inf:
			while(true)
			{
